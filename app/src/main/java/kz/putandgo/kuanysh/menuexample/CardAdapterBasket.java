...
public class CardAdapterBasket  extends RecyclerView.Adapter<CardAdapterBasket.ViewHolder> implements View.OnClickListener {
    ...
    public CardAdapterBasket(List<Basket> basket, Context context){
        super();
    ...
    @Override
    public CardAdapterBasket.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.items_basket, parent, false);
        CardAdapterBasket.ViewHolder viewHolder = new CardAdapterBasket.ViewHolder(v);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(final CardAdapterBasket.ViewHolder holder, final int position) {
